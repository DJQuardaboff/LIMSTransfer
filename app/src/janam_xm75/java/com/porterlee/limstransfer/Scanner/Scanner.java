...
//todo make this work with xm75 sdk (which doesn't exist yet)
...
public class Scanner extends AbstractScanner {
    ...
    public boolean init(Context context) {
        if ((mScanner = IScannerService.Stub.asInterface(ServiceManager.getService("ScannerService"))) != null) {
            try {
                Log.e(TAG, "aDecodeGetAPIVersion()=" + mScanner.aDecodeGetAPIVersion());
                Log.e(TAG, "aDecodeGetDriverVersion()=" + mScanner.aDecodeGetDriverVersion());
                Log.e(TAG, "aDecodeGetModuleName()=" + mScanner.aDecodeGetModuleName());
                Log.e(TAG, "aDecodeGetModuleVersion()=" + mScanner.aDecodeGetModuleVersion());
                Log.e(TAG, "aDecodeAPIGetVersion()=" + mScanner.aDecodeAPIGetVersion());
    ...
    public void onResume(Context context) {
        if (context != null) {
            context.registerReceiver(mResultReceiver, resultFilter, Manifest.permission.SCANNER_RESULT_RECEIVER, null);
